...
import {OrderDirection, useVisitedQuery} from '_app/generated/graphql';
...
export const Visited = () => {
    ...
    const {data, loading, error, refetch, fetchMore} = useVisitedQuery({
        variables: {
            first: 25,
            orderBy: {
